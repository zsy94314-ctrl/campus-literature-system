...
| 序号 | 姓名 | 学号 | 角色 | 主要分工 |
| --- | --- | --- | --- | --- |
| 1 | 周思源 | 202411040239 | 组长 | 在项目中承担主要工作，负责项目总体规划、需求分析、系统架构设计、前后端主体搭建、智能检索与综述生成核心功能实现、前后端联调、项目文档主体撰写、最终汇报与演讲准备。 |
| 2 | 郝思怡 | 202411040237 | 组员 | 负责文档润色与格式整理，参与需求分析、测试记录整理、报告内容校对和文字规范化。 |
| 3 | 黄文政 | 202411040232 | 组员 | 负责后端辅助开发，参与 Spring Boot 接口调试、权限控制检查、智能检索接口联调和后端功能测试。 |
| 4 | 李俊宇 | 202411040254 | 组员 | 负责前端辅助开发，参与页面功能测试、前端交互调整、检索与综述页面辅助完善。 |
| 5 | 王淑珍 | 202411040256 | 组员 | 负责 PPT 制作与展示材料整理，参与系统截图收集、演示流程梳理和答辩辅助准备。 |
